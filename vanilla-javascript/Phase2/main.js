...
/* Extra output for new advanced demos */
function print2(msg) {
    const out = document.getElementById("extraOutput2");
    out.innerText = typeof msg === "object" ? JSON.stringify(msg, null, 2) : msg;
}
...
export function templateLiteralDemo(name = "Guest") {
    print(`Welcome, ${name}! Today is ${new Date().toLocaleDateString()}`);
}

/* Spread & Rest Operators */
export function spreadRestDemo() {
    const arr1 = [1, 2];
    const arr2 = [3, 4];
...
/* More Advanced JS Demo Functions */
...
export function arrowNuanceDemo() {
...
/* Final Foundational Web Dev Demos & Notes */
export async function errorHandlingAsyncDemo() {
...
export async function dynamicImportDemo() {
...
export function formSubmissionDemo() {
