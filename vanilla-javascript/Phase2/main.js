...
/* Shuffling an Array (for making small card games or other games that require shuffling):
    Shuffling an array can be done using the Fisher–Yates algorithm.
    ...
    from the list until no elements remain. The algorithm produces an unbiased
...
/* .nextElementSibling */
const element1 = document.getElementById("vegetables1");
...
prevSibling.style.backgroundColor = "greenyellow";
...
/* Cookie: A small text file stored on a computer used to remember information about the user saved in name=value pairs. */
/* manual way */
// console.log(navigator.cookieEnabled); // -> to check if cookies are enabled
// document.cookie = "firstName=ABC; expires=Sun, 1 January 2030 12:00:00 UTC; path=/"; // -> document.cookie adds a cookie
// document.cookie = "lastName=XYZ; expires=Sun, 1 January 2030 12:00:00 UTC; path=/";
